...
<div class="app">
    <h1 class="nombre-pagina">Crear Paciente</h1>
    <p class="descripcion-pagina">Ingresa los datos del paciente nuevo</p>
    ...
    <form class="formulario" method="POST">
        ...
        <div class="campo">
            ...
            <input type="number" name="edad" id="edad" placeholder="Ingresar edad" step="1" minlength="1" maxlength="3" value="<?php echo s($paciente->edad);?>">
        </div>
        <div class="campo">
        ...
        <input type="submit" class="boton" value="Crear Paciente">
    </form>
